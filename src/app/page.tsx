...
export default function HomePage() {
  ...
  const { visitorCount, pageViews, loading, error } =
    useVisitorAnalytics("home");
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <span
                className="text-2xl font-bold text-bice_blue"
                style={{ color: "#0A678E" }}
              >
                KUSAIDIA
              </span>
      ...
      <main>
        <div className="relative bg-gray-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl">
              ...
              <span
                className="block text-bice_blue"
                style={{ color: "#0A678E" }}
              >
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              className="text-3xl font-extrabold text-rich_black text-center"
              style={{ color: "#031D29" }}
            >
            ...
            <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
              <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                <h3
                  className="text-lg font-medium text-rich_black"
                  style={{ color: "#031D29" }}
                >
                  Donors Doubt
                </h3>
        ...
        <section
          className="py-16 bg-cerulean-100"
          style={{ backgroundColor: "#d0e7f1" }}
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2
              className="text-3xl font-extrabold text-rich_black"
              style={{ color: "#031D29" }}
            >
              Help Us Fix Aid
            </h2>
            <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
              We’re researching until May 2025—share your challenges to shape
              Kusaidia. Surveys available on request!
            </p>
        ...
        {/* Be Part of the Fix */}
        <div
          className="bg-lapis_lazuli py-16"
          style={{ backgroundColor: "#095A7C" }}
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-extrabold text-white">
              ...
              {/* <div
                className="mt-2 text-sm text-cerulean-100"
                style={{ color: "#cce4ed" }}
              >
                {!loading && !error && (
                  <span>This page has been viewed {pageViews} times</span>
                )}
              </div> */}
            </h2>
            <p
              className="mt-4 text-lg text-cerulean-200"
              style={{ color: "#a1cfe2" }}
            >
